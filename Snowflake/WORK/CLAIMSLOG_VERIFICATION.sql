...
-- Verification Query
WITH targets AS (
    SELECT COLUMN1 AS RECORD_ID
    FROM VALUES
        ('1463726287864516608-8119890'),
        ('1463713223026917376-8181585'),
        ('1463713498592690176-8352831'),
        ('1463713343575412736-5721854'),
        ('1463714046352027648-7407115'),
        ('1463724090019774464-46717'),
        ('1463718213976076288-384903'),
        ('1463720327919349760-6046825832'),
        ('1463713122558857216-4310175'),
        ('1463717696206053376-8181736')
),
claim_log AS (
  SELECT l.*
...
SELECT
    ...
    -- Type change DATE to String.
--     LOG_REQ_PATIENT_DOB,
--     REQ_PATIENT_DOB,

    -- Type change DATE to String.
--     LOG_REQ_DATE_OF_SERVICE,
--     REQ_DATE_OF_SERVICE,

--     LOG_REQ_RX_NUMBER,
--     REQ_RX_NUMBER,

    -- ASK TOM: This field is massaged
    LOG_REQ_FILL_NUMBER,
    REQ_FILL_NUMBER,

    -- This field in the claim is using TRY_TO_NUMBER.  Tom said he was ok with VARCHAR
--     LOG_REQ_DAY_SUPPLY,
--     REQ_DAY_SUPPLY,

    -- This field in the claim is using TRY_TO_NUMBER.  Tom said he was ok with VARCHAR
--     LOG_REQ_NUMBER_OF_REFILLS,
--     REQ_NUMBER_OF_REFILLS,

    -- Type change DATE to String.
--     LOG_REQ_DATE_PRESCRIPTION_WRITTEN,
--     REQ_DATE_PRESCRIPTION_WRITTEN,

    -- This field in the claim is using TRY_TO_NUMBER then dividing by 1000.  (It's Calculating)
    LOG_REQ_QUANTITY_DISPENSED,
    REQ_QUANTITY_DISPENSED
